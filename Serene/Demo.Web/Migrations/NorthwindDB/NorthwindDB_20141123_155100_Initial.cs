...
namespace Demo.Migrations.NorthwindDB
{
    ...
    public class DefaultDB_20141123_155100_Initial : Migration
    {
        ...
        public override void Up()
        {
            IfDatabase("SqlServer", "SqlServer2000", "SqlServerCe")
                .Execute.Sql(GetScript("Demo.Web.Migrations.NorthwindDB.NorthwindDBScript_SqlServer.sql"));

            IfDatabase("Postgres")
                .Execute.Sql(GetScript("Demo.Web.Migrations.NorthwindDB.NorthwindDBScript_Postgres.sql"));

            IfDatabase("Postgres")
                .Execute.Sql(GetScript("Demo.Web.Migrations.NorthwindDB.NorthwindDBScript_PostgresData.sql"));

            IfDatabase("MySql")
                .Execute.Sql(GetScript("Demo.Web.Migrations.NorthwindDB.NorthwindDBScript_MySql.sql"));

            IfDatabase("Oracle")
                .Execute.Sql(GetScript("Demo.Web.Migrations.NorthwindDB.NorthwindDBScript_Oracle.sql"));
            IfDatabase("Sqlite")
                .Execute.Sql(GetScript("Demo.Web.Migrations.NorthwindDB.NorthwindDBScript_Sqlite.sql"));
